...
sealed class CommentState extends Equatable {
  const CommentState(
      {this.error, this.comments = const [], this.initialDataLoaded = false});
...
final class CommentsSent extends CommentState {
  CommentsSent(CommentState initState, List<CommentEntity> comments)
      : super(
          comments: comments,
          initialDataLoaded: initState.initialDataLoaded,
        );
